...
export const formatAsJSTDateTime = (src: Date) => format(src, LOCALE_JST, FORMAT_TEMPLATE_DATE_TIME);
export const formatAsJSTDate = (src: Date) => format(src, LOCALE_JST, FORMAT_TEMPLATE_DATE);
